...
class NumSummer
  ...
  def check_doublets
    @nums.each_with_index do |n,i|
      check_num_against_following(n,i)
    end
  end
  def check_num_against_following(n,i)
    for d in i+1..@nums.length-1
      if n+@nums[d] == 2020
        readout(n,d)
      end
    end
...
# readout method works two different ways
# check_triplets keeps checking even after it finds a match
